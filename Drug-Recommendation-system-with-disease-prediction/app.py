...
st.title("Drug Disease Prediction")
st.header("Please enter your symptoms 🩺")

symptoms = st.multiselect('Enter your symptoms so we can predict drug for the disease you have:',[*symptoms_list],key='symptoms')
